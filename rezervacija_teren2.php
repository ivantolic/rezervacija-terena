...
if (isset($_POST['rezervacija'])) {
    ...
    $sql = "INSERT INTO teren1 (user_id, termin, zauzet) VALUES ('$user_id', '$termin', '1')";
...
$reservedTimesQuery = "SELECT termin FROM teren1 WHERE zauzet='1'";
...
<body>
        ...
        <div class="container">
          <h1>Rezerviraj vanjski teren 1</h1>
            ...
            <?php
                ...
                foreach ($timeOptions as $time) {
                    ...
                    if (!$user_id || in_array($time, $reservedTimes)) {
                        echo '<input class="odabir" type="radio" id="' . $time . '" name="termin" value="' . $time . '" disabled>';
                    }else {
                        echo '<input class="odabir disabled"  type="radio" id="' . $time . '" name="termin" value="' . $time . '">';
                    }
